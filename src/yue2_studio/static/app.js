...
function bindRunMenus(){
  ...
  dlBtn.onclick=e=>{e.stopPropagation();const showing=dlMenu.hidden;closeRunMenus();dlMenu.hidden=!showing;};
  edBtn.onclick=e=>{e.stopPropagation();const showing=edMenu.hidden;closeRunMenus();edMenu.hidden=!showing;};
  ...
  if(prog){
    prog.addEventListener('click',()=>{prog.dataset.userToggled='1';});
  }
}
